...
class Student:
    def __init__(self,root):
        ...
        title_lb1=Label(bg_img,text="STUDENT MANAGEMENT SYSTEM",font=("times new roman",32,"bold"),bg="white",fg="red")
        ...
        current_course_frame.place(x=10,y=104,width=580,height=90)
        ...
        dep_combo=ttk.Combobox(current_course_frame,textvariable=self.var_dep,font=("times new roman",10,"bold"),width=15,state="readonly")
        dep_combo["values"]=("Select Department","CSE","IT","CE","ME","PE","EE","ECE") 
        dep_combo.current(0)
        ...
        course_combo=ttk.Combobox(current_course_frame,textvariable=self.var_course,font=("times new roman",10,"bold"),width=15,state="readonly")
        ...
        year_combo=ttk.Combobox(current_course_frame,textvariable=self.var_year,font=("times new roman",10,"bold"),width=15,state="readonly")
        year_combo["values"]=("Select year","2020-21","2021-22","2022-23","2023-24") 
        year_combo.current(0)
        year_combo.grid(row=1,column=1,padx=2,pady=5,sticky=W)
                               
        #semester
        semester_label=Label(current_course_frame,text='Department',font=("times new roman",10,"bold"),bg="white")
        semester_label.grid(row=1,column=2,padx=10)
        
        semester_combo=ttk.Combobox(current_course_frame,textvariable=self.var_semester,font=("times new roman",10,"bold"),width=15,state="readonly")
        ...
        btn_frame.place(x=0,y=153,width=575,height=20)
        
        save_btn=Button(btn_frame,text="Save",command=self.add_data,width=25,font=("times new roman",7,"bold"),bg="blue",fg="white")
        save_btn.grid(row=0,column=0)
        
        update_btn=Button(btn_frame,text="Update",command=self.update_data,width=25,font=("times new roman",7,"bold"),bg="blue",fg="white")
        update_btn.grid(row=0,column=1)
        
        delete_btn=Button(btn_frame,text="Delete",command=self.delete_data,width=25,font=("times new roman",7,"bold"),bg="blue",fg="white")
        delete_btn.grid(row=0,column=2)
        
        reset_btn=Button(btn_frame,text="Reset",width=25,command=self.reset_data,font=("times new roman",7,"bold"),bg="blue",fg="white")
        reset_btn.grid(row=0,column=3)
        
        
        btn_frame1=Frame(class_Student_frame,bd=2,relief=RIDGE,bg="white")
        btn_frame1.place(x=0,y=173,width=575,height=20)
        take_photo_btn=Button(btn_frame1,text="Take a photo sample",command=self.generate_dataset,width=50,font=("times new roman",7,"bold"),bg="blue",fg="white")
        take_photo_btn.grid(row=1,column=0)
    
        update_photo_btn=Button(btn_frame1,text="Update photo sample",width=50,font=("times new roman",7,"bold"),bg="blue",fg="white")
        ...
        img_right=Image.open(r"C:\Users\sonal\OneDrive\Desktop\face_recognition_system\college_images\Stanford.jpeg")
        img_right=img_right.resize((590,100),Image.LANCZOS)
        ...
        # Search_frame.place(x=10,y=100,width=580,height=53)
        
        # search_label=Label(Search_frame,text='Search by:',font=("times new roman",10,"bold"),bg="red")
        # search_label.grid(row=0,column=0,padx=7,pady=3,sticky=W)
        
        # search_combo=ttk.Combobox(Search_frame,font=("times new roman",7,"bold"),width=15,state="readonly")
        # search_combo["values"]=("Select","Roll no","Phone_no") 
        # search_combo.current(0)
        # search_combo.grid(row=0,column=1,padx=2,pady=10,sticky=W)
        
        # search_entry=ttk.Entry(Search_frame,width=20,font=("times new roman",7,"bold"))
        # search_entry.grid(row=0,column=2,padx=7,pady=3,sticky=W)
        
        # search_btn=Button(Search_frame,text="Search",width=15,font=("times new roman",7,"bold"),bg="blue",fg="white")
        # search_btn.grid(row=0,column=3,padx=2)
        
        # showAll_btn=Button(Search_frame,text="Show All",width=15,font=("times new roman",7,"bold"),bg="blue",fg="white")
        # showAll_btn.grid(row=0,column=4,padx=2)
        
        #table frame
        table_frame=Frame(Right_frame,bd=2,bg="White",relief=RIDGE)
        table_frame.place(x=10,y=154,width=580,height=250)
            ...
            try:
                ...
                if Upadate>0:
                    ...
                    my_cursor.execute("update student set Dep=%s,course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_id=%s",(
                            ...
                            self.var_address.get(),self.var_teacher.get(),self.var_radio1.get(),self.va_std_id.get()
                            ))
                else:
                    if not Upadate:
                        return
    ...
    def generate_dataset(self):
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.va_std_id.get() == "":
            ...
            try:
                ...
                # Fetching all records and counting the number of students
                my_cursor.execute("SELECT * FROM student")
                ...
                # Updating the student record with the provided details
                my_cursor.execute("update student set Dep=%s,course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_id=%s",(
                                                                                                                                                                                                            
                            self.var_dep.get(),self.var_course.get(),self.var_year.get(),self.var_semester.get(),self.var_std_name.get(),
                            self.var_div.get(),self.var_roll.get(),self.var_gender.get(),self.var_dob.get(),self.var_email.get(),self.var_phone.get(),
                            self.var_address.get(),self.var_teacher.get(),self.var_radio1.get(),self.va_std_id.get()==id+1
